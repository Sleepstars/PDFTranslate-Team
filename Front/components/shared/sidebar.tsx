...
import { LayoutDashboard, FileText, Users, Settings, Boxes, FileType, X, Shield, BarChart3, ClipboardList } from 'lucide-react';
...
export function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  const adminLinks = [
    ...
    { href: `/${locale}/admin/tasks`, label: t('adminTasks'), icon: ClipboardList },
